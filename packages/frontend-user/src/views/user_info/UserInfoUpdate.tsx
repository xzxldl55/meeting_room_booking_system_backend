...
import { UserInfo, getUserInfo, updateUserCaptcha, updateUserInfo } from '../../api/interface';
import { HeadPicUpload } from './HeadPicUpload';
import { syncUserInfo } from '../../utils';
...
export function UserInfoUpdate() {
	...
	const { startCountDown, disabledCaptchaBtn, captchaBtnCountDown } = useCountDown(10);
